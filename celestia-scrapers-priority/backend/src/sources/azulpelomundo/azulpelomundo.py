...
BASE_URL = "https://azulpelomundo.example"  # Substituir pela URL real

class AzulpelomundoParser:
...
class AzulpelomundoScraper:
    def __init__(self, user: Optional[str] = None, password: Optional[str] = None):
        ...
        self.parser = AzulpelomundoParser()
    ...
    async def search(self, origin: str, destination: str, date: str, **kwargs) -> List[Dict]:
        ...
        async with HttpSession() as s:
            ...
            for it in items:
                it.setdefault("source", "azulpelomundo")
            return items
